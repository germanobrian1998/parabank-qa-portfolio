...
- Name: api/transfer.api.spec.ts >> Transfer API — contract tests >> [BUG H-007] transfer with negative amount should not increase source balance
- Location: tests/api/transfer.api.spec.ts:147:7

# Error details

```
Error: Una transferencia con monto negativo no debe incrementar el saldo de la cuenta origen
